...
class BgeRerank:
    def __init__(self, model_path: str = "ckpt/BAAI/bge-reranker-large/"):
        if not os.path.exists(model_path):
            # 模型下载
            from modelscope import snapshot_download
            snapshot_download('BAAI/bge-reranker-large', cache_dir="ckpt")
...
if __name__ == '__main__':
    ...
    chunks = [{"chunks":unit} for unit in chunks]
    res = bge_reranker.get_result(query=query, all_chunks=chunks)
    print(res)
